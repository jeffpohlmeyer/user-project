...
SECRET_KEY = os.getenv('USER_PROJECT_SECRET_KEY')
...
""" remove these when you handle your own auth and user admin"""
LOGIN_REDIRECT_URL = 'http://localhost:8080/user/confirmed/'
